...
from algorithms import deep_q_learning_without_experience_replay_control
from brains import SimpleMLPQSABrain
from line_world import S, A, LineWorldEnv, num_states
import numpy as np

if __name__ == "__main__":
    brain = SimpleMLPQSABrain(len(S), len(A), lr=0.001)
    env = LineWorldEnv()

    deep_q_learning_without_experience_replay_control(
        env.deep_reset,
        env.deep_get_state,
