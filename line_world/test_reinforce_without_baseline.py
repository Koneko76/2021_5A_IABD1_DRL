...
from algorithms import reinforce_without_baseline
from brains import SimpleMLPPiSABrainReinforce
...
if __name__ == "__main__":
    ...
    brain = SimpleMLPPiSABrainReinforce(len(S), len(A), lr=0.0001)
    env = LineWorldEnv()
